...
from admin import admin_app, db, logger
from admin.models.user import User, Group, Selector, Role
from admin.utils.decorater import permission_required, permission_required_inter


@admin_app.route('/users', methods=['POST'])
@admin_app.route('/users/<int:user_id>', methods=['PUT'])
# @login_required
...
@admin_app.route('/users/<int:user_id>', methods=['DELETE'])
@permission_required('user_write')
@login_required
...
# Group
@admin_app.route('/groups')
@login_required
def show_group():
    return jsonify({})


@admin_app.route('/groups', methods=['POST'])
@admin_app.route('/groups/<int:group_id>', methods=['PUT'])
# @login_required
...
@admin_app.route('/groups/<int:group_id>', methods=['DELETE'])
@login_required
@permission_required('group_write')
...
# Selector
@admin_app.route('/selectors')
@login_required
def show_selector():
    return jsonify({})


@admin_app.route('/selectors', methods=['POST'])
@admin_app.route('/selectors/<int:selector_id>', methods=['PUT'])
# @login_required
...
@admin_app.route('/selectors/<int:selector_id>', methods=['DELETE'])
@login_required
@permission_required('selector_write')
